...
/** A Filter that checks a greater-than-or-equal numeric comparison. */
public class GreaterThanEq extends BiNumeric {
    public GreaterThanEq(TemplateDirective left, TemplateDirective right) {
        super(left, right);
    }
