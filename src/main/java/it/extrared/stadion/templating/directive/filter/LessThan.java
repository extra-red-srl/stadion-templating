...
/** A Filter that checks a less-than numeric comparison. */
public class LessThan extends BiNumeric {

    public LessThan(TemplateDirective left, TemplateDirective right) {
        super(left, right);
    }
